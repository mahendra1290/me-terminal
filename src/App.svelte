...
<main
  class="min-h-[100vh] text-white bg-gray-600 flex justify-center items-center"
>
  <div
    class="w-full flex flex-col max-w-4xl h-screen md:h-[33rem] text-sm font-mono shadow-md rounded-lg overflow-hidden bg-gray-800 border-current"
  >
